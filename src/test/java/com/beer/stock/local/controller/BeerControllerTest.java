...
public class BeerControllerTest {
	...
	void whenPOSTIsCalledThenABeerIsCreated() throws JsonProcessingException, Exception {
		...
		//then
		mockMvc
			.perform(post(BEER_API_URL_PATH)
	...
	void whenGETIsCalledWithValidNameThenOkStatusIsReturned() throws Exception {
		...
		//then
		mockMvc
			.perform(MockMvcRequestBuilders.get(BEER_API_URL_PATH + "/" + beerDTO.getName())
			.contentType(MediaType.APPLICATION_JSON))		
	...
	void whenGETListWithBeersIsCalledThenOkStatusIsReturned() throws Exception {
		...
		//then
		mockMvc
			.perform(MockMvcRequestBuilders.get(BEER_API_URL_PATH)
			.contentType(MediaType.APPLICATION_JSON))		
			.andExpect(status().isOk())
	...
	void whenDELETECalledWithValidIdTheNoContentStatusIdReturned() throws Exception {
		...
		//then
		mockMvc
			.perform(MockMvcRequestBuilders.delete(BEER_API_URL_PATH + "/" + beerDTO.getId())
			.contentType(MediaType.APPLICATION_JSON))		
	...
	void whenDELETECalledWithInValidIdThenNotFoundStatusReturned() throws Exception {
		...
		//then
		mockMvc
			.perform(MockMvcRequestBuilders.delete(BEER_API_URL_PATH + "/" + INVALID_BEER_ID)
			.contentType(MediaType.APPLICATION_JSON))		
			.andExpect(status().isNotFound());			
	}
